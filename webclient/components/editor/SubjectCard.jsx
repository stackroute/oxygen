...
export default class SubjectCard extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        this.setState({selectedDomain: nextProps.domainName, subjectCardJsx: nextProps.subjectCardJsx});
        let subjectCard = {};
    ...
    displayCardHeader = () => {
        return (<CardHeader title='Subject' titleStyle={{
            fontSize: 20,
            marginLeft: '50%'
        }}/>);
    }
    ...
    displayCardActions = () => {
        ...
        if (this.state.enableEdit) {
            keyValueDisplay = this.editProperties();
        } else {
        ...
        return (
            <CardActions>
                ...
                <Row >
                    ...
                    <FlatButton label='Edit' onTouchTap={this.enableEdit.bind(this)} style={{
                        float: 'right'
                    }}/>
                </Row>
            </CardActions>
    ...
    editProperties = () => {
        return (<EditNode domainName={this.state.selectedDomain} property={this.state.attrObj}/>);
    }
