...
//For generalize adding
describe("Adding multiple subject node with object node using predicate :", function() {
    it('Testing for all node to add', function(done) {
        request
            .put('/domain/:domainname/subject/:nodetype/:nodename')
            .expect(200, done);
